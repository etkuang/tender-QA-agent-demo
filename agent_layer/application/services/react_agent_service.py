...
from agent_layer.domain.tools.agent_tools import TOOL_CLASSES, BaseTool
...
class ReActAgent:
    ...
    def __init__(self, retriever: HybridRetriever, llm: LLMGenerator, max_steps: int = 5):
    ...
    async def run(self, question: str) -> str:
        ...
        print(f"\n[ReActAgent] question: {question}")
        print(f"   max_steps={self.max_steps}")

        base_history = "(no history)"
