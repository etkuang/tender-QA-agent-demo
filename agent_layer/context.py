...
from agent_layer.schemas import ContextResolution, ConversationInput, Message
...
结合最近消息，将“该公司、那个项目、这条规定、其”等表达改写成独立问题。
...
class ContextResolver:
    ...
    async def resolve(
        ...
        if not self._needs_resolution(rewritten, history_messages):
