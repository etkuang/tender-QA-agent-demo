...
from agent_layer.application.session_manager import SessionManager
...
class E2EEvaluator:
    ...
    def save_report(self, result: E2EOverallResult, output_dir: Path = Path("agent_layer/data/eval_results")):
        """保存评估报告"""
